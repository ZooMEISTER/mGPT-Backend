...
public interface ConversationMapper {
    ...
    @Select("SELECT id,conversation_id,role,content,model,created_time FROM chat_history WHERE conversation_id=#{conversationId} ORDER BY created_time ASC")
    ...
    @Insert("INSERT INTO chat_history (id,conversation_id,role,raw_content,content,model) VALUES (#{id},#{conversation_id},#{role},#{raw_content},#{content},#{model})")
    int InsertNewChatHistory(String id, String conversation_id, String role, String raw_content, String content, String model);
